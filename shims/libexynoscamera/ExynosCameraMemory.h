...
public:
    ExynosCameraGraphicBufferAllocator(int cameraId = 0);
...
public:
    ExynosCameraIonAllocator(int cameraId = 0);
...
public:
    ExynosCameraMHBAllocator(int cameraId = 0);
...
public:
    ExynosCameraGrallocAllocator(int cameraId = 0);
